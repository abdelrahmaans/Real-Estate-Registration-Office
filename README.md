...
- الداشبورد يعرض آخر 10 تحديثات فقط من `audit_logs` بدل كارت أعلى المكاتب، مع fallback من أحدث الموظفين والخطابات لو view لم تعمل بعد.
- صفحة التقارير أصبحت مركز متابعة للتحديثات والبحث العام في بيانات النظام بدل تكرار تفاصيل الموظفين أو الخطابات.
- صفحة الخطابات أصبحت مخصصة للخطابات فقط: بحث، فلاتر، كروت واضحة، تعديل، وحذف ناعم.
...
- صفحة التقارير الحالية تعرض سجل التحديثات ونتائج بحث عامة للوصول السريع للموظفين والخطابات.
- صفحة الخطابات هي المكان الأساسي لتصفية الخطابات وإدارتها.
